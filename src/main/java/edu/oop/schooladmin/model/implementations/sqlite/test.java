...
// Проверка изменений в группах и удаления назначений при удалении учителя
        ...
        // System.out.println("------изменить назначение с Id 2. Установить GroupId 10------");
        // System.out.println("------назначение с Id 2 до изменения------");
        // System.out.println(testAppointment.getTeacherAppointmentById(2));
        // TeacherAppointment appointment2 = testAppointment.getTeacherAppointmentById(2);
        ...
        System.out.println(testRating.getRatingsByValue(5));
